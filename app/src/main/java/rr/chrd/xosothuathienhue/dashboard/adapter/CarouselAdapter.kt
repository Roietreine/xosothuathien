package rr.chrd.xosothuathienhue.dashboard.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import rr.chrd.xosothuathienhue.databinding.CarouselviewBinding
...
class CarouselAdapter(val dataImg : ArrayList<Int>): RecyclerView.Adapter<CarouselAdapter.AdapterHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterHolder = AdapterHolder(
        CarouselviewBinding.inflate(LayoutInflater.from(parent.context),parent,false))
